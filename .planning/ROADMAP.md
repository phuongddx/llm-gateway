...
- [ ] **Phase 1: Gateway Runtime Hardening** - Fail fast on bad config; bounded analytics writes under concurrent streaming; OpenAI-format SSE error frames
...
|-------|----------------|--------|-----------|
| 1. Gateway Runtime Hardening | 1/3 | In Progress|  |
